...
## Bug Reports
Please use the [GitHub Issue Tracker](https://github.com/vardumper/dom-orm/issues) to report bugs. Include as much detail as possible, including your PHP version and a code snippet to reproduce the issue.
